...
## Project Structure
    ...
    ├── miraki_innovation_35931  # Django project configurations
...
1. Clone this repo and `cd miraki_innovation_35931`
...
2. Clone this repo and `cd miraki_innovation_35931`
